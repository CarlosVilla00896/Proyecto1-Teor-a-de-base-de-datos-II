...
import Panels.DDL;
import Panels.DropFunction;
import Panels.ListarFunctions;
 ...
 * @author PC
 */
public class Functions extends javax.swing.JInternalFrame {
    GridBagLayout layout = new GridBagLayout();
     DDL ddl;
    DropFunction drop;
    ListarFunctions list;
    ...
    public Functions() {
        initComponents();
        ddl = new DDL();
        drop = new DropFunction();
        list = new ListarFunctions();
    ...
    private void initComponents() {
        ...
        jButtonDrop.setText("Eliminar Function");
        ...
        jButtonList.setText("Listar Function");
