...
public class ListarViews extends javax.swing.JPanel {
    QueryManager query;
    public String sql = "";
    public ListarViews() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Solo se listarán las views del Sistema y las que se hayan creado en el usuario en curso");
    ...
    private void jBtVerTablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtVerTablesActionPerformed
        this.sql = "select v.viewdefinition, t.tablename, s.schemaname \n "
        + "from sys.sysviews v inner join \n "
        + "sys.systables t on v.tableid = t.tableid inner join \n "
