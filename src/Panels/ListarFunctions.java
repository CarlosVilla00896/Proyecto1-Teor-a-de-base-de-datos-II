 ...
 * @author PC
 */
public class ListarFunctions extends javax.swing.JPanel {
    QueryManager query;
    public String sql = "";
    
    public ListarFunctions() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Solo se listarán las funciones del Sistema y las que se hayan creado en el usuario en curso");
