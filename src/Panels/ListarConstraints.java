...
public class ListarConstraints extends javax.swing.JPanel {
    QueryManager query;
    public String sql = "";
    
    public ListarConstraints() {
        initComponents();
    ...
    private void jBtVerTablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtVerTablesActionPerformed
        this.sql = "select t.tablename, c.constraintname, c.type, s.schemaname \n "
                + "from sys.systables t inner join \n "
                + "sys.sysconstraints c on t.tableid = c.tableid inner join \n "
                + "sys.sysschemas s on c.schemaid = s.schemaid";
